...
namespace SourceFuse.E_commerce.API.Migrations
{
    ...
    [Migration("20230607185226_ApplicationRoleNullable")]
    partial class ApplicationRoleNullable
    {
            ...
            modelBuilder.Entity("SourceFuse.E_commerce.Entities.Identity.ApplicationUser", b =>
                {
                    ...
                    b.HasOne("SourceFuse.E_commerce.Entities.Customer", "Customer")
                        .WithOne("User")
                        .HasForeignKey("SourceFuse.E_commerce.Entities.Identity.ApplicationUser", "CustomerId");
